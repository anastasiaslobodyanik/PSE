...
\newpage
 ...
 Das Befehlsmuster ist zur Bearbeitung von den Requests (Funktionen ``\textit{deny()}`` und ``\textit{accept()}`` in Klasse ``\textit{Request}``) verwendet.Mit Hilfe dieses Musters wird die Bearbeitung der Requests von den Requests selbst, wie in der   \hyperref[Befehl]{Abbildung 4} angezeigt ist, getrennt.\\
...
\begin{itemize}
	\item \atr{USER_ID}{String}{public} {bla}
	\item \atr{name}{String}{private}{bla}	
	\item \atr{email}{String}{private}{bla}
\end{itemize}

\subparagraph*{Methoden}  % skip this if there are no methods
\begin{itemize}
	\item \mtd{searchResource}{List<Resource>}{searchParameters: String} {public}{bla  \inlinecode{USER_ID}}
	
	\item \mtd{addResource}{Resource}{ }{public}{bla  \inlinecode{USER_ID}}
	
	\item \mtd{accessResource}{void}{searchParameters: String} {public}{bla  \inlinecode{USER_ID}}
	
	\item \mtd{sendAccessRequest}{void}{resourceID: String} {public}{bla  \inlinecode{USER_ID}}
	
	\item \mtd{cancelRequest}{void}{requestID: String} {public}{bla  \inlinecode{USER_ID}}
\end{itemize}
...
\begin{itemize}
	...
	\item \mtd{denyAccessPermission}{void}{resourceID:String, userID:String}{public}{
	bla  \inlinecode{USER_ID}
	}
