...
\subsection{View}
Unsere View Klassen bestehen aus kleineren generischen Klassen die schon in Django zur Verfügung stehen (django.views.generic; django.view.generic.details; django.utils.decorators). Ausnahmen sind die Klassen HandleRequestView, PermissionsEditingView und BlockView.
...
\paragraph*{Klasse ChosenRequestsView}
 Diese Klasse bezeichnet die Subseite wo der Benutzer etscheidet einen Request entweder abzulehnen oder zu genehmigen. 
...
\class{MyResourcesView imports CreateView}
Dient zur Erstellung von neuen Ressourcen.

\paragraph*{Klasse DeleteResource}
 Diese Klasse bezeichnet die Subseite wo der Benutzer einen Löschrequest sendet.
 \class{DeleteResource imports method_decorator}
 Dient zur Prüfung für Adminrechte. 
 \class{DeleteResource imports DeleteView}
 Wenn der Benutzer Adminrechte hat, dann kann er die Ressource löschen.
 \class{DeleteResource imports FormView}
...
\class{PermissionForChosenResourceView imports PermissionsEditingView}
Zeigt zwei Optionen(Checkboxes) - "Zugriffsrechte" und "Besitzerrechte".
\class{PermissionForChosenResourceView imports CreateView}
...
\class{PermissionForChosenResourceView imports DeleteView}
...
\class{ManageUsersView imports DeleteView}
Dient zum Löschen von Benutzer.
\class{ManageUsersView imports BlockView}
...
\class{ManageUsersView imports ManageUsersView}
