...
\newglossaryentry{Lese-Rechte}
{
	name={Lese-Rechte},
	description=
	{
		Rechte den Inhalt einer Ressource zu lesen.
	}
}
...
\item Der Benutzer kann zum Zugriff der Ressourcen ein Request dem Ressourcenbesitzer senden.
...
\begin{itemize}[itemsep=0pt]
\item Einsatz in einem Webportal mit einer Datenbank %TODO noch ergaenzen
\end{itemize}
