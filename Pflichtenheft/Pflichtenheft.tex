...
\item Der Ressourcenbesitzer kann ein \gls{Löschen-Request} für seine eigenen Ressourcen dem Administrator senden.
...
\item Der Administrator kann Rechte auf Ressourcen beliebig vergeben (ohne selbst Ressourcenbesitzer zu sein).
\item Der Administrator kann Ressourcenbesitzer ändern. 
\end{itemize}
...
\begin{itemize}[itemsep=0pt]
\item Administratoristrator(en) der Webseite %(Mitarbeiter von V-FOR-WaTer)
