...
\textbf{Beschreibung:}\\
\begin{enumerate}[label=(\arabic*), leftmargin=*]
	\item Der Ablauf ist ähnlich zu dem in \ref{FAA1} beschriebenen. Unterschied ist, dass jeder Benutzer dieses Request senden kann und natürlich die Sache(nämmlich die Adminrechte), die durch das Request angefragt wird.\\ %TODO
	\end{enumerate}
...
\item Der Ressourcenbesitzer kann in seiner Profilseite für eine bestimmte Ressource durch Klicken des \grqq{Zugriffsrechte vergeben}\grqq -Buttons Zugriffsrechte an andere Benutzer vergeben. %TODO
\end{enumerate}
