...
\textbf{Beschreibung:}\\
\begin{enumerate}[label=(\arabic*), leftmargin=*]
\item Der Ressourcenbesitzer kann in seiner Profilseite für eine bestimmte Ressource durch Klicken auf des \grqq{Zugriffsrechte vergeben}\grqq -Button Zugriffsrechte anderen Benutzern ohne Request vergeben.
\end{enumerate}
...
\textbf{Beschreibung:}\\
\begin{enumerate}[label=(\arabic*), leftmargin=*]
\item Der Ressourcenbesitzer kann in seiner Profilseite für eine bestimmte Ressource durch Klicken auf des \grqq{Besitz-Rechte teilen}\grqq -Button seine Besitzerrechte mit anderen Benutzern teilen.
\end{enumerate}
...
\textbf{Beschreibung:}\\
\begin{enumerate}[label=(\arabic*), leftmargin=*]
\item Wird eine Ressource von Administrator gelöscht, werden allen Ressourcenbesitzer per Email benachrichtigt.
\end{enumerate}
