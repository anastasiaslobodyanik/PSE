...
urlpatterns = [
    ...
    re_path(r'^approve-access-request/\d*$', approve_access_request, name='approve access request'),
    re_path(r'^deny-access-request/\d*$', deny_access_request, name='deny access request'),
