...
\multirow{2}{*}{} 13& \multirow{2}{*}{} TestEditNameView& test-not-logged-in & Getestet, ob man seinen Namen ändern kann, wenn man nicht eingeloggt ist.& HTTP Status Code 302: Der Benutzer wird zur ,,Login``-Seite weitergeleitet.    \\ \cline{3-5} 
...
\multirow{2}{*}{} T020 : Name editieren & \multirow{2}{*}{} F020 &  Klicke auf ,,Profile``-Button  & Profilseite ist angezeigt: Benutzername, Liste der Requests, ,,My Resources``-Button \\ \cline{3-4}    &  & Klicke auf den Namen & Name- und Vorname-Felder sind angezeigt \\ \cline{3-4}    &  & Schreibe den Namen und Vornamen  &  Die neue Name und Vorname werden in den Felder geschrieben \\ \cline{3-4}    &  & Klicke auf ,,OK``-Button  & die neue Name und Vorname werden im Profilseite korrekt angezeigt \\ \hline

\multirow{2}{*}{} T030 : Ressourcenzugriff& \multirow{2}{*}{} F030 & Klicke auf ,,Resources Overview``-Button  & Die Liste der Ressourcen wird angezeigt \\ \cline{3-4}    &  & Klicke auf ,,Access``-Button  & Herunterladen-Fenster wird geöffnet \\ \cline{3-4}    &  & Klicke auf ,,Speichern``-Button  & Ressource wird heruntergeladen \\ \hline

\multirow{2}{*}{} T040 : Ressourcenerstellung & \multirow{2}{*}{} F040 & Klicke auf ,,Profile``-Button  & Profilseite ist angezeigt: Benutzername, Liste der Requests, ,,My Resources``-Button  \\ \cline{3-4}    &  & Klicke auf ,,My Resources``-Button  & ,,Add``-Button (,,+``-Button) und die Liste der Ressourcen sind angezeigt \\ \cline{3-4}    &  & Klicke auf ,,Add``-Button  & Felder: ,,Name``, ,,Type``, ,,Description``, ,,Link`` und ,,Add``-Button sind angezeigt \\ \cline{3-4}    &  & Fülle die Felder aus, füge einen Link hinzu and klicke auf  ,,Add``-Button  & Zur ,,My Resources``-Seite weitergeleitet, erstellte Ressource ist  in der Liste verfügbar \\ \hline

\multirow{2}{*}{} T050 : Access Request senden& \multirow{2}{*}{} F050 & Klicke auf ,,Resources Overview``-Button  & ,,Resources``-Seite ist angezeigt , einschlie{\ss}lich einer Liste von Ressourcen und eines Suchfeldes \\ \cline{3-4}    &  & Klicke auf ,,Send Request``-Button  & Nachricht-Dialog ist angezeigt , mit optionalem Beschreibungsfeld  , ,,Yes`` und  ,,Close``-Button \\ \cline{3-4}    &  & Klicke auf ,,Yes``-Button  & Anstatt des ,,Send Request``-Buttons ist ,,Cancel Request``-Button angezeigt\\ \hline

\multirow{2}{*}{} T060 : Benachrichtigung& \multirow{2}{*}{} F060 & Klicke auf ,,Resources Overview``-Button  & ,,Resources``-Seite ist angezeigt , einschlie{\ss}lich einer Liste von Ressourcen und eines Suchfeldes \\ \cline{3-4}    &  & Klicke auf ,,Send Request``-Button & Anstatt des ,,Send Request``-Buttons ist ,,Cancel Request``-Button angezeigt  \\ \cline{3-4}    &  & Anfrage Akzeptieren/ablehnen (Aus dem Besitzer-Konto)  & \multirow{2}{*}{} Die Logdatei enthält eine Email und Beschreibung  \\ \cline{3-3}    &  & Öffne die Logdatei  & \\ \cline{3-3}    &  & Suche nach dem Email  &  \\ \hline
...
\endhead
%
\multirow{2}{*}{} T220 : Übersicht der Requests& \multirow{2}{*}{} F180 & Klicke auf ,,Profile``-Button  & Die Liste der erhaltenen Requests wird angezeigt \\ \hline

\multirow{2}{*}{} T230 : Übersicht der Ressourcen& \multirow{2}{*}{} F190 & Klicke auf ,,Profile``-Button  & ,,My Resources``-Button wird angezeigt \\ \cline{3-4}    &  & Klicke auf ,,My Resources``-Button  & Liste der eigenen Ressourcen wird angezeigt  \\ \hline

\multirow{2}{*}{} T240 : Vergabe der Zugriffsrechte& \multirow{2}{*}{} F200 &Auf ,,Profile``-Button klicken  & ,,My Resources``-Button wird angezeigt \\ \cline{3-4}    &  & Auf ,,My Resources``-Button klicken  &Die Liste der eigenen Ressourcen wird angezeigt, folgende Buttons werden für jede Ressource angezeigt: ,,Access``, ,,Edit Permissions``, ,,Delete`` \\ \cline{3-4}    &  & Klicke auf ,,Edit Permissions``-Button  &,,Search``-Feld wird angezeigt \\ \cline{3-4}    &  & Schreibe den Benutzernamen und Klicke auf ,,Search``-Button  &gesuchter Benutzer wird angezeigt \\ \cline{3-4}    &  & Klicke auf ,,Reader``-Button und ,,Confirm``-Button &Benutzer soll als Leser angezeigt werden und ,,Access``-Button soll jetzt beim Benutzer-Konto angezeigt werden \\ \hline

\multirow{2}{*}{} T250 : Request auf Zugriffsrechte ablehnen& \multirow{2}{*}{} F210 & Klicke auf ,,Profile``-Button  & Die Liste der erhaltenen Requests wird angezeigt \\ \cline{3-4}    &  & Klicke auf ,,Deny``-Button  & Dialogbox wird angezeigt, sie enthält ein Eingabefeld, ,,Yes``- und ,,Close``-Button \\ \cline{3-4}    &  & Klicke auf ,,Yes``-Button  & Request soll nicht mehr angezeigt werden und Benutzer soll nicht als Reader angezeigt werden  \\ \hline

\multirow{2}{*}{} T260 : Request auf Zugriffsrechte akzeptieren& \multirow{2}{*}{} F210 & Klicke auf ,,Profile``-Button  & Die Liste der erhaltenen Requests wird angezeigt \\ \cline{3-4}    &  & Klicke auf ,,Accept``-Button  & Dialogbox wird angezeigt, sie enthält ein Eingabefeld, ,,Yes`` und ,,Close``-Button \\ \cline{3-4}    &  & Klicke auf ,,Yes``-Button  & Request soll nicht mehr angezeigt werden  \\ \cline{3-4}    &  & Klicke auf ,,My Resources``-Button , ,,Edit Permission``-Button   & Benutzer soll als Leser angezeigt werden \\ \hline
